...
{!! Form::open(['url' => $route, 'method' => 'GET']) !!}
    <div class="form-row">
        ...
        <div class="form-group col-md-2">
            @can('add_sipas-suratkeluar')
                <a href="{{ url('admin/sipas/suratkeluar/create') }}" class="btn btn-icon btn-block icon-left btn-success btn-filter"><i class="fas fa-plus-circle"></i> Create</a>
            @endcan
        </div>
    </div>
{!! Form::close() !!}
